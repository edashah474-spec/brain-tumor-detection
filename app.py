...
if uploaded_file is not None:
    ...
    with st.spinner("Loading AI model and analyzing... (first load takes 1-2 mins)"):
        model = load_model()
    ...
    st.divider()
    st.warning("⚕️ For educational purposes only. Always consult a radiologist.")

st.divider()
st.markdown("**Safa Sayyed | CS AI-ML | KLE Technological University, Belgaum**")
